...
from ws_module.proto import backend_pb2, backend_pb2_grpc
import grpc
...
class PostsViewset(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        post = backend_pb2.Post(id=1, date="as", content="asa", likes=2, username="as")
        point = backend_pb2.NewPost(followers=backend_pb2.Users(users=['asas', "sdsds"]))
        feature = stub.addPostEvent(point)
        print(feature)
