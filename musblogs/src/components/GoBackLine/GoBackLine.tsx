...
import { GoBackLineProps } from "../../Types/BasicElements";

export const GoBackLine: React.FC<GoBackLineProps> = ({...props}) => {
    return (
        <div className="go_back_line">
            <div className="go_back_img" onClick={props.onClickFunction}>
