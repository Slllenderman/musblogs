        ...
        <div className="feed">
            ...
            <div className="feed_content">
                <div className="top_options">
                    <ImageDiv src={formToolkit.go_back} class="set_img first" alt="go_back" onClickFunction={goBack} />
                ...
                <div className="changing">
                        ...
                        <div className="top_inputs">
                            <div className="reg_form">
                                <div className="desc_name">
                                    Регистрация: {GetMonthOfDate(user.date_joined)} {GetYearOfDate(user.date_joined)} г.
                                </div>
                    ...
                    <div className="save_button">
                        <Button text="Сохранить изменение" class="basic_button" onClickFunction={putNewInfo} />
                    </div>
                </div>
            </div>
        </div>
